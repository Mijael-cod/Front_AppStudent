...
import 'visualizarcomentarios_model.dart';
export 'visualizarcomentarios_model.dart';

class VisualizarcomentariosWidget extends StatefulWidget {
  const VisualizarcomentariosWidget({Key? key}) : super(key: key);

  @override
  _VisualizarcomentariosWidgetState createState() =>
      _VisualizarcomentariosWidgetState();
}

class _VisualizarcomentariosWidgetState
    extends State<VisualizarcomentariosWidget> {
  late VisualizarcomentariosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VisualizarcomentariosModel());
  }
