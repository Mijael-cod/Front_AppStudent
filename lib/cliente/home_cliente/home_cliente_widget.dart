...
class HomeClienteWidget extends StatefulWidget {
  ...
  @override
  _HomeClienteWidgetState createState() => _HomeClienteWidgetState();
}
...
class _HomeClienteWidgetState extends State<HomeClienteWidget>
  ...
  late Map<String, dynamic> personaDatita = {};
  ...
  Future<List<dynamic>> fetchData(String codigoPersona) async {
    ...
    final response = await http.get(
      Uri.parse(
          'https://nestjs-pi-postgres.onrender.com/api/v1/solicitud/aceptadas/contratador/$codigoPersona'),
      headers: {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('buscartrabajador');
                            },
                            child: const Icon(
                              Icons.search_sharp,
                              color: Colors.white,
                                                ...
                                                ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.asset(
                                                    'assets/images/pexels-mikhail-nilov-8923035.jpg',
                                                    width: double.infinity,
                                                ...
                                                ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.asset(
                                                    'assets/images/manualidades.jpg',
                                                    width: double.infinity,
                                                    height: double.infinity,
                                                    fit: BoxFit.cover,
                                                  ),
